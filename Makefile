...
bin/geometry-test: build/test/main.o build/test/geometry_test.o
	gcc -Wall -Werror build/test/main.o build/test/geometry_test.o build/src/main.o build/src/func.o -o bin/geometry-test -lm
